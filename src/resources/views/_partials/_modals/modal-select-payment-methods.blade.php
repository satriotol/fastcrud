            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-sm-between align-items-center border-bottom pb-3 mb-3">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <img src="{{ asset('assets/img/icons/payments/ae-' . $configData['style'] . '.png') }}"
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                    <div class="d-flex gap-2 align-items-center">
                        <img src="{{ asset('assets/img/icons/payments/jcb-' . $configData['style'] . '.png') }}"
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3">
                    <div class="d-flex gap-2 align-items-center">
                        <img src="{{ asset('assets/img/icons/payments/dc-' . $configData['style'] . '.png') }}"
